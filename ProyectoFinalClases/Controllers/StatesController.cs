...
using ProyectoFinalClases.DAL.Models;

namespace ProyectoFinalClases.Controllers
{
    public class StatesController : Controller
    {
        private readonly ProyectoFinalClasesContext _context;

        public StatesController()
        {
            _context = new ProyectoFinalClasesContext();
        }
