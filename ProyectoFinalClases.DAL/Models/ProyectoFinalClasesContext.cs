...
namespace ProyectoFinalClases.DAL.Models
{
    public partial class ProyectoFinalClasesContext : DbContext
    {
        public ProyectoFinalClasesContext()
        {
        }

        public ProyectoFinalClasesContext(DbContextOptions<ProyectoFinalClasesContext> options)
            : base(options)
        {
        }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseSqlServer("Server=LAPTOP-UHLKNP9S\\JUANYUCOJIMENEZ;Database=ProyectoFinalClases;User ID=ProyectoFinalClases;Password=12345;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<AspNetUsers>(entity =>
            {
                ...
                entity.HasOne(d => d.Tenant)
                    ...
                    .HasConstraintName("FK__AspNetUse__Tenan__300424B4");
            });
            ...
            modelBuilder.Entity<UserProjects>(entity =>
            {
                ...
                entity.HasOne(d => d.User)
                    .WithMany(p => p.UserProjects)
                    .HasForeignKey(d => d.UserId)
                    .HasConstraintName("FK__UserProje__UserI__2E1BDC42");
            });
        }
    }
}
